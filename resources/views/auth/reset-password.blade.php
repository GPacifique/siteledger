...
<head>
    ...
    <title>Reset Password - SiteLedger</title>
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" required value="{{ old('email', $email) }}" readonly>
            </div>

            <div class="form-group">
                <label for="password">New Password</label>
                <input type="password" id="password" name="password" required autofocus placeholder="Enter new password">
