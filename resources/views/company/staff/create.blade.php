...
<head>
    ...
    <title>Add Staff Member - {{ $company->name }} - SiteLedger</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>➕ Add Staff Member <span class="company-badge">{{ $company->name }}</span></h1>
            <p>Add a new staff member to your company</p>
        </div>
        ...
        <div class="form-card">
            <form action="{{ route('company.staff.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    <label class="checkbox-group">
                        ...
                        <div>
                            ...
                            <div class="label-desc">Grant this user admin privileges to manage other staff members</div>
                        </div>
                    </label>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('company.staff.index') }}" class="btn btn-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
