                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="category" id="category">
                            <option value="utilities" {{ old('category', $payment->category) == 'utilities' ? 'selected' : '' }}>🔌 Utilities (Electric, Water, Internet)</option>
                            <option value="rent" {{ old('category', $payment->category) == 'rent' ? 'selected' : '' }}>🏢 Rent</option>
                            <option value="insurance" {{ old('category', $payment->category) == 'insurance' ? 'selected' : '' }}>🛡️ Insurance</option>
                            <option value="office_supplies" {{ old('category', $payment->category) == 'office_supplies' ? 'selected' : '' }}>📎 Office Supplies</option>
                            <option value="software" {{ old('category', $payment->category) == 'software' ? 'selected' : '' }}>💻 Software & Subscriptions</option>
                            <option value="maintenance" {{ old('category', $payment->category) == 'maintenance' ? 'selected' : '' }}>🔧 Maintenance & Repairs</option>
                            <option value="taxes" {{ old('category', $payment->category) == 'taxes' ? 'selected' : '' }}>📋 Taxes & Licenses</option>
                            <option value="travel" {{ old('category', $payment->category) == 'travel' ? 'selected' : '' }}>✈️ Travel & Transport</option>
                            <option value="marketing" {{ old('category', $payment->category) == 'marketing' ? 'selected' : '' }}>📢 Marketing & Advertising</option>
                            <option value="professional_services" {{ old('category', $payment->category) == 'professional_services' ? 'selected' : '' }}>👔 Professional Services</option>
                            <option value="other" {{ old('category', $payment->category ?? 'other') == 'other' ? 'selected' : '' }}>📦 Other</option>
                        </select>
                        @error('category')
                            <div class="error">{{ $message }}</div>
                        @enderror
