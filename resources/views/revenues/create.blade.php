            ...
            <form action="{{ route('revenues.store') }}" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="amount_received" id="amount_received" step="0.01" value="{{ old('amount_received') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="payment_method" id="payment_method" placeholder="e.g., Bank Transfer, Cash" value="{{ old('payment_method') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" placeholder="Add any notes or details about this revenue...">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
